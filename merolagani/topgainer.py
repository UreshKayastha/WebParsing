...
for k in matches_body:
    ...
    b=symbol.append(k.find_element(By.XPATH,'./td[2]').text)
...
df=pd.DataFrame({'SN':sn,'symbol':symbol,'Name':name,'LTP':value,'Point_Change':Point_Change,'Per_ChangeD':Per_ChangeD,'Per_Change':Per_Change})
